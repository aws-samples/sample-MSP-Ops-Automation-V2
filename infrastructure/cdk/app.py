...
agentcore_stack = AgentCoreStack(
    ...
    env=env,
    description="AgentCore Runtime, Gateway, Memory, Identity, Policy, Observability"
)
...
backend_stack = BackendStack(
    ...
    env=env,
    description="FastAPI on ECS Fargate with ALB and API Gateway"
)
...
frontend_stack = FrontendStack(
    ...
    env=env,
    description="React SPA on S3 with CloudFront CDN"
)
